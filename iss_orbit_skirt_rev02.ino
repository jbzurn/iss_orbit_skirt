...
int location[] = {5,6,7,8,9,10,11,12,13,A0,A1,A2,A3,A4,A5,2,3,}; // array of all the LED pins on the Lilypad Arduino. 
                                                                // Enter them in the order they will be lit. The
                                                                // program will select them in sequence.
int home_location = 5;  // this is your 'home' pin location. 
